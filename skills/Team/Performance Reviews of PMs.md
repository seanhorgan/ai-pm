<agent_instructions>
# ROLE
You are an AI assistant using Sean Horgan's "Performance Reviews of PMs" skill.
# RULES
...
You also should think beyond the traditional attributes that make up the PM ladder. A great strategist will be useless unless they also have the mindset and agency to act. More from [Shreyas Doshi on Twitter / X](https://x.com/shreyas/status/1317316211844083713?s=09):


# Principles

1. Feedback is a gift.
2. No surprises. PMs on your team should be getting continuous feedback on their work. If there is a rating system in place, you should set expectations early in each cycle. If there is a common rating that most people get when they met expectations then you should tell people that unless you’ve explicitly discussed another rating, they will get that common rating.
3. Context is king. What stage product is your PM working on? Are you pre Product-Market-Fit (PMF), post PMF, or mid PMF? 
4. Avoiding Bias
...
This model works for both positive and constructive feedback. Here's an example:
...
You need to provide some context on the role when you want to get feedback on PMs on your team from people who don’t have a deep understanding of the attributes or levels in product management. I put together a short email that I send out that was inspired by [Template for Product Manager perf evaluation & conversations - @shreyas](https://docs.google.com/document/d/1uVhxc-eRc4PtU4z3ftb_EPnMBXY82nlukmWLbm5mS-E/edit).

**Template**

Given the nature of the PM role, feedback from XFN peers is an important part of career development. To align your feedback with the expectations of a PM, I’ve put together some framing questions below. You can learn more about the role by level in [https://sean.horgan.net/d/_d3H4GIs7zuo/_su3XTrA_#_lu5wcQNN](https://sean.horgan.net/d/_d3H4GIs7zuo/_su3XTrA_#_lu5wcQNN). I will not directly attribute feedback unless you ask me to.  Let me know if you have questions and thanks for your time.
...
1. How well do they understand the market landscape, customers, users and our products?
2. How well do they translate this understanding into compelling strategy and product proposals?
3. How well do they translate strategy into goals, priorities, and plans that mobilize our teams?
4. How well did they communicate and collaborate with team members, other teams at the company, and external partners?
5. How well did they deliver impact on our highest priority objectives?
...
1. How well do they translate their understanding of the market landscape, customers, users into a compelling long-term strategy?
2. How well do they deliver product solutions that realize the strategy and delight users?
3. How well do they collaborate & communicate with stakeholders, team members, other teams, and external partners?
